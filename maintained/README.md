...
3. Single authoritative Mini backend through native Tailscale HTTPS bearer pairing.
...
The Air connects to the Mini's Tailscale HTTPS endpoint through normal bearer pairing, so changing
Wi-Fi or hotspot networks does not create another Mini backend.
