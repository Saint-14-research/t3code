...
Before this sequence starts, the active server reads the command projection and refuses while any
provider session is starting/running, any turn is active, or native background work is live.
